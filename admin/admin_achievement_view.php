...
<body>
    ...
    <main>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                    <a href="admin_achievement_edit.php" class="waves-effect waves-light btn"><i class="material-icons left">edit</i>Edit Post</a>
                </div>
                <form method="POST">
                    <input type="text" hidden name="achieve_id" value="<?php echo $achieve['achieve_id']; ?>">
