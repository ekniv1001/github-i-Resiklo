            ...
            <nav class="green lighten-1 z-depth-0" role="navigation">
                <div class="container">
                    <div class="nav-wrapper">
                        <a href="index.php" class="brand-logo" style="font-weight: 600;"> <em>Achievements</em></a>
        ...
        <div class="container">
            <div class="row">
                ...
                <?php foreach ($query as $achieve) { ?>
                    <div class="col s12">
                        <div class="divider"></div>
                        <h2 class="header"><?php echo $achieve['achieve_title']; ?></h2>               
                        ...
                        <div class="card horizontal small">
                            ...
                            <div class="card-stacked">
                                ...
                                <div class="card-action teal">
                                    <a href="admin_achievement_view.php?achieve_id=<?php echo $achieve['achieve_id']; ?>" class="white-text">Read More<i class="material-icons">navigate_next</i></a>
                                </div>
                            </div>
                        </div>
                    </div>
