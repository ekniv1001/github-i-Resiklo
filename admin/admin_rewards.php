...
<body>
    ...
    <main><br>
            ...
            <div>
                <div class="col s12">
                    <div class="card-panel teal lighten-2 center">
                        <strong class="white-text" style="font-size: 25px;">Rewards Information</strong>
                    </div>
                        ...
                        <form method="POST" action="" enctype="multipart/form-data">
                            <div class="row">
                                <div class="card-panel teal lighten-2">
                                    <strong class="white-text">Add Rewards Information</strong>
                                </div>
                            </div>
                            <div class="container">
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <input id="title" type="text" name="reward_name" class="validate" required>
                                        <label for="title">Reward Item</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-field col s12">
                                        <i class="material-icons prefix green-text text-green lighten-1">description</i>
                                        <input id="title" type="number" name="reward_quantity" class="validate">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <i class="material-icons prefix green-text text-green lighten-1">description</i>
                                        <input id="title" type="text" name="reward_source" class="validate">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <i class="material-icons prefix green-text text-green lighten-1">description</i>
                                        <input id="title" type="number" name="reward_cost" class="validate">
        ...
        <div class="row">
            <div class="col s12">
                <div class="card-panel teal lighten-2">
                    <strong class="white-text">List of Rewards</strong>
                </div>
                <table class="centered">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $show['reward_stock']; ?></td>
                                <td><a href="admin_edit_reward.php?reward_id=<?php echo $show['id_reward']; ?>" class="waves-effect waves-light btn"><i class="material-icons right">edit</i>edit</a><br>
                                    <a href="admin_add_stock.php?reward_id=<?php echo $show['id_reward']; ?>&stock=<?php echo $show['reward_stock']; ?>" class="waves-effect waves-light btn"><i class="material-icons right">add</i>Stock</a>
                ...
                <div class="row">
                    <div class="col s12">
                        <form method="POST" action="" enctype="multipart/form-data">
                            <div class="row">
                                <div class="card-panel teal lighten-2">
                                    <strong class="white-text">Add Reward</strong>
                                </div>
