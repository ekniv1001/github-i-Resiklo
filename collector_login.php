...
if (isset($_POST['login'])) {
    ...
    $query = "SELECT  * from tbl_userinfo where user_name = '$username' and password = '$password' and user_type = '$collector'";
    ...
    if (mysqli_num_rows($run_admin) == 1) {
        ...
        header('location:collector/collector_home_view.php');
    } else {
